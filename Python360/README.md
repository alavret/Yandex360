...
| Пункт меню | Описание |
|------------|----------|
|1. Delete all departments and create them from file ([описание](#delete-all)).| Удаляет все подразделения из организации Яндекс 360 и создаёт новые из файла | 
...
<a name="delete-all"> #### 1. Delete all departments and create them from file. #### </a>
- Скрипт на входе получает список подразделений в файле `deps_list.csv`.
